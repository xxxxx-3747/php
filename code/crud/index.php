  ...
  <main class="container">
    ...
    <table class="table table-hover">
      ...
      <?php while ( $item = mysqli_fetch_assoc($query)) : ?>
        <tr>
          <th scope="row" name="xh"><?php echo $item['xh'] ?></th>
          <td><img src="<?php echo $item['photo'] ?>" class="rounded" alt="<?php echo $item['name'] ?>" name="photo"></td>
          <td name="name"><?php echo $item['name'] ?></td>
          <td name="sex"><?php echo $item['sex'] == 0?'♀' : '♂';  ?></td>
